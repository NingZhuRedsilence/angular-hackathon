...
* `git clone git@github.com:rumblex/angularattack2016-zyhmjlgwzn.git`

* `cd angularattack2016-zyhmjlgwzn`
...
If you receive an error message `"You do not have permission to publish to zyhmjlgwzn.2016.angularattack.io"`, it might mean another team member has already deployed your project to Surge. Ask them to run the next step to give you access.

### Step 3) Add Your Team Members to Surge

* `surge . --add zouying007@gmail.com,mh58@rice.edu,gengwuli@gmail.com`
